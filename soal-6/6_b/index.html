    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-radius">
            ...
            <div class="modal-body text-center">
                ...
                <p class="placeholder mt-4 mb-5">Data Bintang telah berhasil dihapus</p>
            </div>
        </div>
    </div>
</div>
...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    ...
    <div class="modal-body modal-body-padding">
        ...
        <form action="" method="post">
            <div class="form-group">
                <input name="name" class="form-control form-control-lg black-border placeholder" type="text" value="Joko">
            </div>
            <div class="form-group mt-5">
                <div class="select-side"></div>
                <select name="work" class="form-control form-control-lg black-border placeholder appearance-none" id="sel1">
                    <option selected>Fronend Dev</option>
                    <option>Backend Dev</option>
                    <option>UX Designer</option>
                    <option>UI Designer</option>
                </select>
